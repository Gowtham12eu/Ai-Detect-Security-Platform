    ...
    <div className="min-h-screen bg-white flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="relative z-10 bg-white border border-indigo-100 rounded-3xl shadow-2xl p-6 sm:p-10 w-full max-w-sm sm:max-w-md animate-slide-up">
        <div className="text-center mb-6 sm:mb-8">
          ...
          <p className="text-gray-500 mt-2 text-sm sm:text-base">Join SecureAI Platform for free</p>
        </div>
        ...
        <div className="space-y-3 sm:space-y-4">
          ...
          <button onClick={handleRegister} disabled={loading}
            className="w-full bg-gradient-to-r from-green-500 to-cyan-500 hover:from-green-600 hover:to-cyan-600 text-white py-3 rounded-xl font-bold text-sm sm:text-base transition-all duration-300 hover:scale-105 disabled:opacity-50">
            {loading ? (
